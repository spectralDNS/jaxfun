...
class MatrixProtocol(Protocol):
    ...
    def scale(self, alpha: complex | Array) -> MatrixProtocol:
        """Return ``alpha * A``."""
        ...
    ...
    def __mul__(self, other: complex | Array) -> MatrixProtocol: ...
    def __rmul__(self, other: complex | Array) -> MatrixProtocol: ...
