...
"""
from duckdb.experimental.spark.sql.catalog import Function
...
from jaxfun.galerkin.tensorproductspace import TensorProduct, tpmats_lu_factor, tpmats_to_kron
...
for M in [10, 20, 40, 80, 120]:
    ...
    D = FunctionSpace(M, Chebyshev, bcs)
