...
trainer.train(opt_soap, 1000, abs_limit_change=0, update_global_weights=-1)
trainer.global_weights = loss_fn.update_global_weights(
    u.module, trainer.global_weights, 0.5
)
